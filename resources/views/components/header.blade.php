        ...
        <div class="flex items-center justify-between h-20">
            ...
            <div class="flex items-center">
                <a href="#" class="flex items-center gap-x-3 group">
                    <div class="w-12 h-12 bg-gradient-to-r from-orange-500 to-pink-500 rounded-2xl flex items-center justify-center text-white font-black text-2xl shadow-lg group-hover:shadow-xl transition-all">
                        E
                    </div>
                    <div>
                        <span class="text-2xl font-black bg-gradient-to-r from-orange-600 to-pink-600 bg-clip-text text-transparent">Electro</span>
            ...
            <div class="flex-1 max-w-xl mx-10">
                <form action="#" method="GET">
                    <div class="relative">
                        ...
                        <button type="submit" class="absolute right-2 top-1/2 -translate-y-1/2 bg-gradient-to-r from-orange-500 to-pink-500 text-white px-6 py-2 rounded-xl text-sm font-bold">Search</button>
                    </div>
                </form>
            </div>
            ...
            <div class="flex items-center gap-x-4">
                <a href="#" class="relative bg-gray-50 p-2.5 rounded-2xl hover:bg-orange-50 transition-all group">
                    ...
                    <span class="absolute -top-1 -right-1 bg-red-500 text-white text-[10px] font-bold w-5 h-5 flex items-center justify-center rounded-full">12</span>
                </a>
        ...
        <nav class="border-t border-gray-100 mt-2">
            <div class="flex items-center h-12">
                ...
                <div class="relative group">
                    <button class="flex items-center gap-x-2 px-6 h-12 bg-gradient-to-r from-orange-500 to-pink-500 text-white font-bold text-sm rounded-xl hover:shadow-lg transition-all">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="absolute left-0 top-full hidden group-hover:block w-screen max-w-7xl bg-white shadow-2xl rounded-2xl mt-2 z-50">
                                ...
                                <div>
                                    ...
                                    <ul class="space-y-2">
                                        @foreach($category->children as $child)
                                            <li>
                                                <a href="#" class="text-gray-500 hover:text-gray-900 text-sm transition block hover:pl-2">
                                                    {{ $child->name }}
                                                </a>
                                            </li>
                                        @endforeach
                        ...
                        <div class="bg-gradient-to-r from-orange-50 to-pink-50 rounded-b-2xl p-4 flex justify-between items-center">
                ...
                <div class="ml-auto flex items-center gap-x-3">
                    <div class="bg-green-100 text-green-700 px-3 py-1.5 rounded-full text-xs font-bold">⭐ 4.9 ★★★★★</div>
